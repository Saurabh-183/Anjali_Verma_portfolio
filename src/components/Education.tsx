...
export default function Education() {
  return (
    ...
    >
      ...
      <h3 className="relative text-lg font-bold text-gray-900 dark:text-white mb-3 md:mb-4 flex items-center gap-2">
        <GraduationCap className="w-5 h-5 text-blue-400" />
        Education
      </h3>
      <div className="relative">
        <h4 className="text-sm md:text-base font-semibold text-gray-800 dark:text-gray-200">Bachelor of Computer Application</h4>
        <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400 mt-1">Dr. Virendra Swaroop Institute of Computer Studies, Kanpur</p>
